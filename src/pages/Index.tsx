  ...
  const giftCards: GiftCard[] = [
    {
      ...
      amount: 1000,
      image:
        "https://images.unsplash.com/photo-1592512399470-65ba36d1df92?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80",
    ...
    },
    {
      ...
      amount: 2500,
      image:
        "https://images.unsplash.com/photo-1584553279313-7ba74b330356?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80",
    ...
    },
    {
      ...
      amount: 5000,
      image:
        "https://images.unsplash.com/photo-1556656793-08538906a9f8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80",
  ...
  const instructionSteps = [
    {
      ...
      description:
        "Выберите подходящий номинал Apple Gift Card из доступных вариантов.",
      icon: "CreditCard",
    },
    {
      title: "Оплатите заказ",
      description:
        "Выполните безопасную оплату с использованием предпочитаемого метода.",
      icon: "Wallet",
    },
    {
      title: "Получите код",
    ...
    },
    {
      ...
      description:
        "Войдите в свой Apple ID и активируйте подарочную карту в App Store.",
      icon: "Gift",
    },
  ];
      ...
      <header className="py-4 px-6 md:px-8 sticky top-0 bg-white/80 backdrop-blur-md z-10 border-b border-gray-200">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <a href="#howto" className="hover:text-blue-600 transition-colors">
              Как использовать
            </a>
          ...
          <div className="space-y-6">
            <div className="border-b border-gray-200 pb-4">
              ...
              <p className="text-gray-600">
                Apple Gift Cards не имеют срока действия и могут быть
                использованы в любое время.
              </p>
            </div>
            <div className="border-b border-gray-200 pb-4">
              <h3 className="text-xl font-medium mb-2">
                Где можно использовать Apple Gift Card?
              </h3>
              <p className="text-gray-600">
                В App Store, iTunes Store, для покупки Apple Music, Apple TV+,
                Apple Arcade, iCloud и других сервисов Apple.
              </p>
            </div>
            <div className="border-b border-gray-200 pb-4">
              <h3 className="text-xl font-medium mb-2">
                Как быстро я получу код активации?
              </h3>
              <p className="text-gray-600">
                Код активации отправляется на ваш email сразу после
      ...
      <section className="py-16 px-6 md:px-8 bg-gray-900 text-white">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Подарите возможность выбора из миллионов приложений, игр, песен,
            фильмов и многого другого.
          </p>
          <Button
          ...
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-gray-600 max-w-xs">
                Apple Gift Card может быть использована в App Store, iTunes
                Store, для Apple Music и других сервисов Apple.
              </p>
            </div>
